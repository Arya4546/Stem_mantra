...
export default function WhyChooseUsSection() {
  return (
    <section className="relative pt-16 pb-0 bg-gray-50 overflow-hidden border-t border-gray-200">
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        ...
        <div className="relative flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-0 mt-8">
            ...
            {benefitsLeft.map((item, idx) => (
              ...
              >
                <div className="flex items-center gap-3 lg:flex-row-reverse mb-2">
                  <div className={`w-12 h-12 rounded-full bg-white shadow-md border flex items-center justify-center ${item.iconColor}`}>
                ...
                <p className="text-gray-700 text-sm md:text-base max-w-sm leading-snug">
                  {item.description}
                </p>
              </motion.div>
            ))}
          ...
          {/* CENTER */}
          <div className="hidden lg:flex w-[30%] justify-center relative h-[450px] items-center">
            ...
            >
              {[
                { angle: 0, Icon: FaLaptopCode, color: "text-orange-500 border-orange-500" },
                { angle: 60, Icon: FaUserGraduate, color: "text-purple-600 border-purple-600" },
                { angle: 120, Icon: FaClipboardCheck, color: "text-green-600 border-green-600" },
                { angle: 180, Icon: FaCogs, color: "text-indigo-800 border-indigo-800" },
                { angle: 240, Icon: FaBullseye, color: "text-purple-800 border-purple-800" },
                { angle: 300, Icon: FaProjectDiagram, color: "text-red-500 border-red-500" },
              ].map((item, i) => (
                <div
                  key={i}
                  className="absolute"
                ...
                >
                  <div className={`w-16 h-16 rounded-full border-4 bg-white shadow-xl flex items-center justify-center ${item.color}`}>
