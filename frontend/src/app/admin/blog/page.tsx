      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              href="/admin/blog/new"
              className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-orange-500 to-teal-500 text-white rounded-lg font-medium hover:bg-orange-600 transition-colors"
            >
          ...
          <div className="flex flex-col lg:flex-row lg:items-center gap-4">
            ...
            <div className="flex items-center bg-slate-100 rounded-lg p-1">
              <button
                ...
                className={`p-2 rounded-lg transition-colors ${viewMode === "grid" ? "bg-white shadow-sm" : "text-slate-500"
                  }`}
              >
              ...
              <button
                ...
                className={`p-2 rounded-lg transition-colors ${viewMode === "list" ? "bg-white shadow-sm" : "text-slate-500"
                  }`}
              >
        ...
        {posts.length === 0 ? (
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {posts.map((post, index) => (
              ...
              >
                <div className="relative aspect-video bg-gradient-to-br from-orange-500 to-teal-500">
                  {post.featuredImage ? (
                    <Image
